...
const MAP_OR_NON_LANDMARK =
  /\b(taifa|caliphate|emirate|umayyad|abbasid|ottoman empire|kingdom of|duchy of|county of|province of|comarca|vega de|state of|sultanate|khanate|principality of|margraviate|voivodeship|oblast of|governorate)\b/i;
